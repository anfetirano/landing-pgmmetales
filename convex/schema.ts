...
export default defineSchema({
  ...
  quotations: defineTable({
    ...
    shareFirstViewedAt: v.optional(v.number()),
    shareLastViewedAt: v.optional(v.number()),
    shareViewCount: v.optional(v.number()),
    shareLastViewedCountryCode: v.optional(v.string()),
    shareViewCountryCodes: v.optional(v.array(v.string())),
    internalShareToken: v.optional(v.string()),
    internalSharedAt: v.optional(v.number()),
    internalShareFirstViewedAt: v.optional(v.number()),
    internalShareLastViewedAt: v.optional(v.number()),
    internalShareViewCount: v.optional(v.number()),
    internalShareLastViewedCountryCode: v.optional(v.string()),
    internalShareViewCountryCodes: v.optional(v.array(v.string())),
    status: v.union(
      v.literal("draft"),
      v.literal("pricing"),
      v.literal("ready")
